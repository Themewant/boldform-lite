...
final class BoldForm_Lite {
	...
	private function define_hooks() {
		...
		// Preview the premium Excel/PDF export beside the free Export CSV button, and
		// on the Tools → Entries export panel. These are unconditional free-plugin
		// features — Lite never detects any add-on. An add-on that ships real
		// Excel/PDF export unhooks these callbacks and renders its own controls in
		// their place (see the entry-export module in the paid add-on).
